...
//   final String chatId; // Chat object with name, picture, etc.
...
//       // Load chat details
//       context.read<ChatListCubit>().getChatDetails(widget.chatId);
//     } catch (e) {
//       setState(() {
