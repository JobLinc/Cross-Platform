...
void showModalBasedOnConnectionStatus(BuildContext context,
    String connectionStatus, ProfileCubit cubit, String userId) {
  switch (connectionStatus) {
    case 'Accepted':
      ...
      break;
    case 'Received':
      //showRespondModal(context); // (You will define it: Accept / Reject)
      break;
    case 'Sent':
      //showWithdrawModal(context); // (You already have it: Withdraw request)
      break;
    case 'Blocked':
      //showBlockedModal(context); // (You can design this — maybe only unblock?)
      break;
    case 'Not Connected':
      //showConnectNowModal(context); // (Maybe a simple connect button)
      break;
    default:
